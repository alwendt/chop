...
;	$S19_A	EQU	A
	...
	.286p
	.287
BITOR_TEXT	SEGMENT  BYTE PUBLIC 'CODE'
BITOR_TEXT	ENDS
...
DGROUP	GROUP	CONST,	_BSS,	_DATA
	ASSUME  CS: BITOR_TEXT, DS: DGROUP, SS: DGROUP, ES: DGROUP
EXTRN	_printf:FAR
EXTRN	__chkstk:FAR
_DATA      SEGMENT
...
; Line 16
	...
	mov	[bp-10],ds
; Line 18
	or	BYTE PTR [bp-2],5	;c
; Line 19
	mov	al,[bp-2]	;c
	or	al,52
	or	[bp-2],al	;c
; Line 20
	or	WORD PTR [bp-14],15535	;s
; Line 21
	mov	ax,[bp-14]	;s
	or	ax,325
	or	[bp-14],ax	;s
; Line 22
	or	WORD PTR [bp-20],-22858	;i
; Line 23
	mov	ax,[bp-20]	;i
	mov	dx,[bp-18]
	or	ax,653
...
; Line 27
	...
	or	es:[bx+2],al
; Line 28
	or	BYTE PTR [bp-4],99	;C
; Line 29
	mov	al,[bp-4]	;C
	or	al,32
	or	[bp-4],al	;C
; Line 30
	or	BYTE PTR [bp-16],67	;S
; Line 31
	mov	ax,[bp-16]	;S
	or	al,1
	or	[bp-16],ax	;S
; Line 32
	or	WORD PTR [bp-24],-9342	;I
	or	WORD PTR [bp-22],-1
; Line 33
	mov	ax,[bp-24]	;I
	mov	dx,[bp-22]
...
; Line 36
	...
	or	ax,-5
	or	dx,-1
	or	WORD PTR $S19_A+4,ax
	or	WORD PTR $S19_A+6,dx
; Line 37
	les	bx,[bp-12]	;P
	mov	ax,es:[bx]
	mov	dx,es:[bx+2]
